    ...
    <ul class="pl-5 my-2 text-green-800 dark:text-blue-400">
        ...
        <div class="flex items-center mb-1">
          <span>
            <svg
              ...
              xml:space="preserve"
              class="w-6 h-6 fill-current text-blue-600 dark:text-gray-400"
            >
              <g>
                <path
                  class="st0"
          ...
          <span class="ml-2 text-blue-600 dark:text-gray-400 text-lg">Skillset:</span>
        </div>
      ...
      <li>
        <div class="flex items-center mb-1">
          ...
          <span class="ml-2 text-blue-600 dark:text-gray-400 text-lg">Learning:</span>
        </div>
      ...
      <li>
        <div class="flex items-center mb-1">
          ...
          <span class="ml-2 text-blue-600 dark:text-gray-400 text-lg">Funtime:</span>
        </div>
        <p class="ml-8 font-bold">
